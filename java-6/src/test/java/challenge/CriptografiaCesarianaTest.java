...
public class CriptografiaCesarianaTest {
    ...
    public void deveCriptografarTexto() {
        ...
        String result = criptografia.criptografar(texto);

        assertEquals(TEXTO_CRIPTOGRAFADO, result);
    }
    ...
    public void deveDescriptografarTexto() {
        ...
        String result = criptografia.descriptografar(texto);
        assertEquals(TEXTO_DESCRIPTOGRAFADO, result);
    }
